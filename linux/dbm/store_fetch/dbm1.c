...
int main(){
        ...
        /* use key_datum fetch data */
        data_datum = dbm_fetch(dbm_ptr,key_datum);
        if(data_datum.dptr){                          /* get data not null */
              printf("Data retrieved\n");
              memcpy(&item_retrieved,data_datum.dptr,data_datum.dsize);           /* copy fetch data to own variable */
