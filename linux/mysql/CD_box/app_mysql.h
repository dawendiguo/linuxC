/* A Simple sstructure to represent the current CD, excluding the track infomation */
...
/* A Simplistic track details struture */
...
int add_track(struct current_tracks_st *tracks);
