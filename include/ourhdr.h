/* our own header, to e included * after * all standard system headers */
#ifndef __ourhdr_h
#define __ourhdr_h
...
#define FILE_MODE (S_IRUSR|S_IWUSR|S_IRGRP|S_IROTH)
																							//default file access permissions for new files  660
#define DIR_MODE (FILE_MODE|S_IXUSR|S_IXGRP|S_IXOTH)													//defaultt permissions for new directories  771
...
int serv_sccept(int , uid_t *);		// Programs 15.20 and 15.24
...
#ifdef TIOCGWINSZ
pid_t pty_fork(int *,char *,const struct termios *,const struct winsize *);	// Pointer 19.3
#endif
